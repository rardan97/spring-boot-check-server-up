...
@Service
public class AsyncServerCheckService3 {


//    String url, String reqBody, Map<String, String> headers, String TAG
    ...
    @Autowired
    public AsyncServerCheckService3(WebClient webClient) {
...
//        this.scheduler = Schedulers.boundedElastic();
    ...
    public void checkServerStatusAsync(String url, int maxRetry, String reqBody, Map<String, String> headers, String TAG) {
